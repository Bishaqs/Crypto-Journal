      ...
      {jurisdiction === "other" && (
        <div className="glass rounded-2xl border border-amber-500/20 p-6 text-center" style={{ boxShadow: "var(--shadow-card)" }}>
          ...
          <p className="text-xs text-muted">
            Contact us at <a href="mailto:support@traversejournal.com" className="text-accent hover:underline">support@traversejournal.com</a> and we&apos;ll add it.
          </p>
        </div>
      )}
