    ...
    <div className="max-w-[1600px] mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted mt-0.5">
          Win rate percentage — Wins / Total Trades x 100%. Your batting average.
        </p>
      </div>
      ...
      >
        <div className="p-4 rounded-2xl bg-accent/8 mb-6">
          <Gauge size={48} className="text-accent/60" />
        </div>
        <h2 className="text-lg font-bold text-foreground mb-2">Coming Soon</h2>
        <p className="text-sm text-muted max-w-md mb-4">
          See your win rate over time and by strategy. A high hit ratio with small wins and large losses can still be unprofitable — context matters.
        </p>
