        ...
        <div className="space-y-3">
          ...
          {isAdvanced && (
            <div className="border border-border/30 rounded-xl overflow-hidden">
              ...
              >
                <span className="flex items-center gap-1">🫀 Body ({sectionFilled("body")}) <InfoTooltip text="Physical state affects trading more than most admit. Tired or hungry traders make measurably worse decisions." size={10} articleId="tj-emotions" /></span>
          ...
          {isAdvanced && (
            <div className="border border-border/30 rounded-xl overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 text-[10px] font-semibold text-muted/80 uppercase tracking-wider hover:bg-accent/5 transition-colors"
              >
                <span className="flex items-center gap-1">🧠 Mind ({sectionFilled("mind")}) <InfoTooltip text="Self-identifying biases in real-time is the first step to overcoming them. Your dashboard shows the dollar cost of each bias." size={10} articleId="tj-emotions" /></span>
          ...
          {isAdvanced && (
            <div className="border border-border/30 rounded-xl overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 text-[10px] font-semibold text-muted/80 uppercase tracking-wider hover:bg-accent/5 transition-colors"
              >
                <span className="flex items-center gap-1">🌍 Context ({sectionFilled("context")}) <InfoTooltip text="Knowing what triggers your emotions is half the battle. Your AI coach identifies which triggers precede your worst trading days." size={10} articleId="tj-emotions" /></span>
          ...
          {isExpert && (
            <div className="border border-accent/20 rounded-xl overflow-hidden">
              ...
              >
                <span className="flex items-center gap-1">🔬 Deep Psychology ({sectionFilled("expert")}) <InfoTooltip text="These fields feed the most advanced AI coaching. The more you log, the more personalized and accurate your insights become." size={10} articleId="tj-emotions" /></span>
