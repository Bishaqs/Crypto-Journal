...
export const TEMPLATE_FIELDS: Record<string, FieldDef[]> = {
  ...
  "monthly-recap": [
    { type: "number", key: "month_grade", label: "Rate this month (1-10)", placeholder: "Gut feeling — how did this month go?" },
    { type: "textarea", key: "top_wins", label: "Top 3 wins this month", placeholder: "1. \n2. \n3. " },
    { type: "text", key: "pnl", label: "This month's P&L", prefix: "$", placeholder: "e.g. +5,200 or -1,100" },
    { type: "textarea", key: "best_trade", label: "Best trade", placeholder: "Describe your best trade this month..." },
    { type: "textarea", key: "worst_trade", label: "Worst trade", placeholder: "Describe your worst trade this month..." },
    { type: "emotion", key: "emotion", label: "Dominant emotion this month" },
    { type: "process-score", key: "process_score" },
    { type: "textarea", key: "gratitude", label: "What are you most grateful for this month?", placeholder: "Something specific that made this month worthwhile..." },
    { type: "textarea", key: "biggest_lesson", label: "Biggest lesson", placeholder: "The one insight that matters most..." },
    { type: "textarea", key: "mindset_review", label: "Mindset traps this month", placeholder: "Impostor syndrome? Scarcity thinking? Revenge trading? Overconfidence?" },
    { type: "textarea", key: "goals_next_month", label: "Goals for next month", placeholder: "1-3 specific, measurable goals..." },
    { type: "text", key: "stop_doing", label: "One thing to stop doing", placeholder: "What habit or pattern drained you?" },
  ],
  "mistake": [
