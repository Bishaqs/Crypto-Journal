...
const PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    yearly: { price: "$250", period: "/year", savings: "Save 17%" },
    description: "Professional edge — AI, simulations & tax tools",
    features: [
      "Everything in Pro",
      "AI Trading Coach — ask any AI about your trades",
      "Monte Carlo simulations — stress-test your edge",
      "Crypto tax reports — Form 8949, cost basis tracking",
      "Trade replay & what-if scenarios",
