...
export async function sendBanNotification(to: string, reason?: string) {
  ...
  try {
    await resend.emails.send({
      from: "Stargate Journal <noreply@stargate.trade>",
      to,
      subject: "Your Stargate Journal account has been closed",
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
          ...
          <p style="font-size: 15px; color: #444; line-height: 1.6; margin-bottom: 16px;">
            Your Stargate Journal account associated with <strong>${to}</strong> has been closed by an administrator.
          </p>
          ${reason ? `
          ...
          <p style="font-size: 15px; color: #444; line-height: 1.6; margin-bottom: 24px;">
            ...
            <a href="mailto:support@stargate.trade" style="color: #6c63ff; text-decoration: none;">support@stargate.trade</a>.
          </p>
